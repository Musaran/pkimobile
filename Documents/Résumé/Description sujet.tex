...
Notre objectif est d'implémenter le déploiement automatique d'un système de certification pour mobile. Pour cela, il faudra comparer le fonctionnement d'une PKI et de Kerberos aussi bien de manière expérimentale que fonctionnelle.
